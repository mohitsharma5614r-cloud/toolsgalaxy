...
export const PrivacyPolicy: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 my-8">
      <h1 className="text-3xl font-bold mb-6 text-slate-900 dark:text-white">Privacy Policy for ToolsGalaxy</h1>
      <div className="text-slate-700 dark:text-slate-300 space-y-6">
        <p><strong className="text-slate-900 dark:text-white">Last Updated:</strong> October 26, 2023</p>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">1. Information We Collect</h2>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li><strong className="text-slate-900 dark:text-white">Local Processing:</strong> Tools like document converters, image editors (excluding AI features), calculators, and text utilities operate entirely within your browser. The files and data you use are never sent to our servers.</li>
          <li><strong className="text-slate-900 dark:text-white">AI-Powered Tools:</strong> For tools that require artificial intelligence (e.g., AI Image Editor, AI Article Writer), the data you provide (such as text prompts or images) is sent to our third-party AI service provider's servers for processing. We do not store this data. We encourage you to review the privacy policies of our technology partners for information on how they handle data.</li>
          <li><strong className="text-slate-900 dark:text-white">Microphone Access:</strong> Tools like the Voice Recorder require access to your microphone. Audio data is captured and processed in your browser. You can save the recording to your own device. We do not store your recordings.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">2. How We Use Information</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">3. Cookies and Tracking</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">4. Data Security</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">5. Children's Privacy</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">6. Changes to This Privacy Policy</h2>
        <p>We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page. You are advised to review this Privacy Policy periodically for any changes.</p>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">7. Contact Us</h2>
