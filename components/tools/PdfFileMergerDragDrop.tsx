...
export const PdfFileMergerDragDrop: React.FC<{ title: string }> = ({ title }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Easily merge PDFs by dragging and dropping them.</p>
            </div>
