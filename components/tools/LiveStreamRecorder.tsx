...
export const LiveStreamRecorder: React.FC<{ title: string }> = ({ title }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Enter the URL of the live stream you want to record.</p>
      </div>
      ...
      <div className="p-8 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
        {isLoading ? (
            ...
            <form onSubmit={handleAttempt} className="space-y-4">
                <div>
                    <label htmlFor="stream-url" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                        Live Stream URL
                    </label>
                    <input
                        id="stream-url"
              ...
              <div className="flex">
                  ...
                  <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-amber-700 dark:text-amber-400 space-y-2">
                          <p>
                              Recording live streams directly in a browser is not possible due to browser security policies (CORS) and the terms of service of most streaming platforms, which prohibit unauthorized recording.
                          </p>
                          <p>
