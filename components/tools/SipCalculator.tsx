...
export const SipCalculator: React.FC<{ title: string }> = ({ title }) => {
        ...
        <div className="max-w-6xl mx-auto">
            ...
            `}</style>
             <div className="text-center mb-10">
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Calculate the future value of your Systematic Investment Plan.</p>
            </div>
                ...
                <div className="space-y-8 p-6 bg-white dark:bg-slate-800 rounded-xl shadow-lg border">
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="input-display">₹ {monthlyInvestment.toLocaleString('en-IN')}</span>
                        </div>
