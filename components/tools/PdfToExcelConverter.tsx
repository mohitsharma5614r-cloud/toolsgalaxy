...
export const PdfToExcelConverter: React.FC<{ title: string }> = ({ title }) => {
            ...
            fileReader.onload = async (e) => {
                try {
                    ...
                    if (allTables.length === 0) {
                        setError("No tables could be found in this document.");
                    }
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Extract tables from PDFs into Excel-compatible CSV files.</p>
            </div>
                            ...
                            {extractedTables.map((table, index) => (
                                <div key={index} className="p-4 bg-slate-100 dark:bg-slate-900/50 rounded-lg">
                                    ...
                                    <div className="overflow-x-auto">
                                        ...
                                        {table.rows.length > 5 && <p className="text-center text-xs text-slate-400 mt-2">... and {table.rows.length - 5} more rows</p>}
                                    </div>
                                </div>
                            ))}
                        </div>
