...
const Loader: React.FC = () => (
    <div className="text-center">
        <div className="linkedin-loader mx-auto">
            <div className="li-logo">in</div>
        </div>
        <p className="text-lg font-semibold text-slate-600 dark:text-slate-300 mt-6">Connecting to LinkedIn...</p>
        <style>{`
            .linkedin-loader {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Enter the URL of the LinkedIn post containing the video.</p>
      </div>
      ...
      <div className="p-8 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
        {isLoading ? (
            ...
            <form onSubmit={handleAttempt} className="space-y-4">
                <div>
                    <label htmlFor="li-url" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                        LinkedIn Post URL
                    </label>
                    <input
                        id="li-url"
