...
const Loader: React.FC = () => (
    <div className="text-center">
        ...
        <p className="text-lg font-semibold text-slate-600 dark:text-slate-300 mt-4">Sketching your cartoon... 🎨</p>
    </div>
);

export const CartoonFaceGenerator: React.FC = () => {
    ...
    const handleImageUpload = useCallback(async (file: File) => {
        ...
        try {
            ...
            const generatedImageBase64 = await generateCartoonFace(base64, mimeType);
    ...
    const handleDownload = () => {
        ...
        link.download = `cartoon-face-${Date.now()}.png`;
        link.click();
    };
        ...
        <>
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-extrabold text-slate-900 dark:text-white">Cartoon Face Generator 🎨</h1>
                    <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Turn your face into a modern cartoon character with AI.</p>
                </div>
                    ...
                    <div className="p-6 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
                        {isLoading ? (
                            ...
                            <div className="animate-fade-in text-center space-y-6">
                                <img src={cartoonImageUrl} alt="Generated cartoon face" className="rounded-lg shadow-lg mx-auto max-w-full h-auto max-h-[70vh]" />
