  ...
  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 my-8">
      ...
      <div className="text-slate-700 dark:text-slate-300 space-y-6">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">1. Use of Tools</h2>
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li><strong className="text-slate-900 dark:text-white">Client-Side Processing:</strong> Most tools on this website process your data entirely within your browser. No data or files are uploaded to our servers for these tools. You are responsible for the data you input.</li>
          <li><strong className="text-slate-900 dark:text-white">AI-Powered Tools:</strong> Certain tools utilize third-party AI services for processing. By using these features, you agree that your input data (text prompts, images) will be sent to these third-party services. We do not store your data. Your use of these AI features is subject to the terms and privacy policies of the respective service providers.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">2. Disclaimers</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">3. Limitation Of Liability</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">4. Intellectual Property</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">5. Changes</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">6. Contact Us</h2>
