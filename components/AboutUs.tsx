  ...
  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 my-8">
      ...
      <div className="text-slate-700 dark:text-slate-300 space-y-6">
        <p className="text-lg text-center text-slate-800 dark:text-slate-200">Your One-Stop Hub for Free, Secure, and Powerful Online Tools.</p>
        
        <h2 className="text-2xl font-semibold mt-8 mb-2 text-slate-900 dark:text-white">Our Mission</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">What We Offer</h2>
        <p>We offer a vast and ever-growing collection of tools across various categories, including:</p>
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li><strong className="text-slate-900 dark:text-white">Document Tools:</strong> Merge, split, compress, convert, and edit PDFs and other documents with ease.</li>
          <li><strong className="text-slate-900 dark:text-white">Image Utilities:</strong> From simple conversions and compression to AI-powered editing, we've got your imaging needs covered.</li>
          <li><strong className="text-slate-900 dark:text-white">AI-Powered Creativity:</strong> Generate articles, create presentations, design thumbnails, and explore fun, creative tools powered by cutting-edge AI.</li>
          <li><strong className="text-slate-900 dark:text-white">Calculators & Converters:</strong> A wide range of utility tools for finance, science, and everyday calculations.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">Our Commitment to Your Privacy</h2>
        ...
        <p><strong className="text-slate-900 dark:text-white">Your files and data never leave your computer.</strong></p>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2 text-slate-900 dark:text-white">Powered by Advanced AI</h2>
